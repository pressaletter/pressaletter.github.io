 function setup() {
     ...
     m1 = new M(pos1, l1, val, val)
     e1 = new E(pos1 + val + s, l1, val, val)
     e2 = new E((pos1 + val + s) * 2, l1, val, val)
     t1 = new T((pos1 + val + s) * 3, l1, val, val)

     t2 = new T(0, l2, val, val)
     h1 = new H(105, l2, val, val)
     e3 = new E(210, l2, val, val)

     a1 = new A(0, l3, val, val)
     l1 = new L(105, l3, val, val)
     p1 = new P(210, l3, val, val)
     h2 = new H(315, l3, val, val)
     a2 = new A(420, l3, val, val)
     b1 = new B(525, l3, val, val)
     e4 = new E(630, l3, val, val)
     t3 = new T(735, l3, val, val)


     e = new E(0, 400, val, 420)
     t = new T(0, 900, val, 310)
     i = new I(0, 1290, val, 525)
